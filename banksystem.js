...
class Account_balance extends Customer {
    account_balance = 100;
    constructor(account_balance, firstname, lastname, gender, age, mobile_number) {
...
console.log(obj1.customer_info());
console.log(obj1.getWithdraw(500));
console.log(obj1.getCredit(5000));
export {};
